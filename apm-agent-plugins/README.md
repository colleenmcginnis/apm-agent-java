...
1. Add information about the supported technology in [`docs/reference/index.md`](../docs/reference/index.md)
1. Add a line in [`docs/release-notes/index.md`](../docs/release-notes/index.md)
